...
public class JdbcAccountService implements AccountService {
    ...
    public JdbcAccountService(JDBCSessionManager jdbcSessionManager, AccountFactory accountFactory) {
    ...
    public Account get(Integer id) {
        ...
        Connection connection = jdbcSessionManager.getCurrentConnection();
    ...
    private void updateBalance(int id, double totalBalance, int version) throws SQLException {
        ...
        PreparedStatement statement = jdbcSessionManager.getCurrentConnection().prepareStatement(query);
